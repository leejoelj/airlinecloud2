			...
			<div class="page-search-content">
				...
				<div class="search-tab-content tickets-tab">
					...
					<footer class="search-footer">
						<a href="<?php echo base_url(); ?>one" class="srch-btn">Search</a>	
						<div class="clear"></div>
					</footer>
				</div>
				<!-- // tab content // -->			
		...
		<div class="wrapper-padding-a">
			<div class="offer-slider">
				<header class="fly-in page-lbl">
					<div class="offer-slider-lbl">Widest network, lowest fares!</div>
					
				</header>
				
				<div class="fly-in offer-slider-c">
					<div id="offers" width="1100px">
					<!-- // -->
						<div class="offer-slider-i">
							<div class="offer-slider-txt">
								<div class="offer-slider-l">
									<div class="offer-slider-link"><a href="#">Kiev - Ankara</a></div>
								</div>
					...
					<!-- // -->
						<div class="offer-slider-i">
							<div class="offer-slider-txt">
								<div class="offer-slider-l">
									<div class="offer-slider-link"><a href="#">Kiev - Düsseldorf</a></div>
								</div>
								<div class="offer-slider-r">
									<span>From</span>
									<b>3736 uah</b>
					...
					<br>
						<div class="offer-slider-i">
							<div class="offer-slider-txt">
								<div class="offer-slider-l">
									<div class="offer-slider-link"><a href="#">Kiev - Paris</a></div>
								</div>
								<div class="offer-slider-r">
									<span>From</span>
									<b>4489 uah</b>
					...
					<br>
						<div class="offer-slider-i">
							<div class="offer-slider-txt">
								<div class="offer-slider-l">
									<div class="offer-slider-link"><a href="#">Kiev - Brussels</a></div>
								</div>
								<div class="offer-slider-r">
									<span>From</span>
									<b>5451 uah</b>
